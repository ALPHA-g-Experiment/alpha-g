# `alpha-g-tpc-occupancy-viewer`

Iterate through MIDAS files, and visualize the anode wire and cathode pad
occupancy of the radial Time Projection Chamber. Run the 
`alpha-g-tpc-occupancy-viewer --help` command to make sure you have installed
...
`alpha-g-tpc-occupancy-viewer` may not work as expected:
