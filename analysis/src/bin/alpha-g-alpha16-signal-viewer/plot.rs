...
use alpha_g_detector::alpha16::{ADC16_RATE, ADC32_RATE, ADC_MAX, ADC_MIN};
use pgfplots::{
    axis::{plot::*, *},
    Picture,
};
...
pub fn create_picture(packet: &Packet) -> Picture {
    ...
    let adc_packet = &packet.adc_packet;
    ...
    // When the waveform is empty due to data suppression, I still want to draw
    // the suppression baseline and the suppression threshold.
